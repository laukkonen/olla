...
func TestNewFactory(t *testing.T) {
	...
	expectedStrategies := []string{DefaultBalancerPriority, DefaultBalancerRoundRobin, DefaultBalancerLeastConnections, DefaultBalancerWarmFirst}
...
func TestFactory_Create_DefaultStrategies(t *testing.T) {
	...
	testCases := []struct {
		...
		{DefaultBalancerWarmFirst, DefaultBalancerWarmFirst, true},
